import { IDropdownStyles, IStackStyles, IStackTokens, ITextFieldStyles } from "office-ui-fabric-react";
import { IColumnConfig } from "../types/columnconfigtype";
export declare const stackStyles: Partial<IStackStyles>;
export declare const controlClass: import("office-ui-fabric-react").IProcessedStyleSet<{
    control: {
        marginBottom: string;
        marginRight: string;
        maxWidth: string;
